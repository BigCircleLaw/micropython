...
from dataFormat import _DataFormat  #, uart2
...
_CMD_OLED_BUTTON = 0x08  # OLED 按键使能
_CMD_OLED_Page = 0x09  # OLED 显示某页
_CMD_OLED_Clear = 0x0A  # OLED 清屏
_CMD_OLED_String = 0x0B  # OLED 显示字符串
_CMD_OLED_ClearRow = 0x0C  # OLED 清某一行
_CMD_OLED_TURN = 0x0D  # OLED 翻转屏幕
_CMD_OLED_ROLL = 0x0E  # OLED 控制滚条
_CMD_OLED_DOT = 0x10  # OLED画点
_CMD_OLED_LINE = 0x11  # OLED画线
_CMD_OLED_UPDATE = 0x12  # 自动更新显示设置
_CMD_OLED_REFRESH = 0x13  # 手动刷新显示命令

_DISPLAY_TIMEOUT = 100
