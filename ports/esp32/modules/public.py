...
_CMD_INPUT_KEY = 0x1E  # ����ģ�鲦λ����

_CMD_LED_ON = 0x22  # LED��
_CMD_LED_OFF = 0x23  # LED��
...
_CMD_WiFi_Mode = 0x08
_CMD_WiFi_SET_WiFi = 0x09
_CMD_WiFi_GET_WiFiState = 0x0A
_CMD_WiFi_SET_WiFiDisConnect = 0x0B
_CMD_WiFi_SET_Socket = 0x0C
_CMD_WiFi_Get_SocketState = 0x0D
_CMD_WiFi_SET_SocketDisConnect = 0x0E
_CMD_WiFi_SocketSend = 0x0F
_CMD_WiFi_Send_AT = 0x10
...
_CMD_Color_SetLED = 0x08

_CMD_Bluetooth_Send = 0x08
_CMD_Bluetooth_Name = 0x09
_CMD_Bluetooth_Mode = 0x0A

_CMD_DCSpeedMotor_Power = 0x08
_CMD_DCSpeedMotor_Speed = 0x09
_CMD_Share_Power_On = 0x0A
_CMD_Share_Power_Off = 0x0B
_CMD_Power_IN_On = 0x0C
_CMD_Power_IN_Off = 0x0D

_CMD_LineTracer_Mode = 0x10
_CMD_LineTracer_SET_COM = 0x11
_CMD_LineTracer_Mode_OFF = 0x12
